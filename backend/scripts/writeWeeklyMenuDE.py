...
# Dateien einlesen
pdf_template = os.path.join(base_dir, "../../data/speiseplan_vorlage_de.pdf")
pdf_temp = os.path.join(base_dir, "../../data/temp_speiseplan_de.pdf")
pdf_output = os.path.join(base_dir, f"../../frontend/public/data/{week}_DE.pdf")
